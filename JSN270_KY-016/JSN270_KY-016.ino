...
void setup() {
  ...
  pinMode(blueLedPin, OUTPUT);
	...
	Serial.println("--------- JSN270 RGB LED Example --------");
			...
			if (c == '\n') {                    // if the byte is a newline character
				if (currentLine.length() == 0) {
					if (get_http_request) {
						...
						JSN270.print("Click <a href=\"/RH\">here</a> to turn RED LED on<br>");
						JSN270.print("Click <a href=\"/RL\">here</a> to turn RED LED off<br>");
            JSN270.print("Click <a href=\"/GH\">here</a> to turn GREEN LED on<br>");
            JSN270.print("Click <a href=\"/GL\">here</a> to turn GREEN LED off<br>");
            JSN270.print("Click <a href=\"/BH\">here</a> to turn BLUE LED on<br>");
            JSN270.print("Click <a href=\"/BL\">here</a> to turn BLUE LED off<br>");
